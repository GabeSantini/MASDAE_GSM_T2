DROP TABLE IF EXISTS Assessment_Company_Impact;
DROP TABLE IF EXISTS Assessment_Control_Impact;
DROP TABLE IF EXISTS Assessment_Risk_Impact;
DROP TABLE IF EXISTS Assessment_Sub_Risk_Impact;
DROP TABLE IF EXISTS Assessment_Parent_Impact;
DROP TABLE IF EXISTS Control_Risk_Reach;
DROP TABLE IF EXISTS Control_Sub_Risk_Reach;
DROP TABLE IF EXISTS Control_Parent_Reach;
...
DROP TABLE IF EXISTS Appetite;
DROP TABLE IF EXISTS Risk;
DROP TABLE IF EXISTS Sub_Risk;
DROP TABLE IF EXISTS Parent_Risk;
